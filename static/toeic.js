...
function renderDashboard() {
  ...
  document.getElementById("toeic-content").innerHTML = `
    <section class="toeic-goal-hero">
      <p class="eyebrow">START FROM ZERO / ONE YEAR GOAL</p>
      <h1><span>${toeicData.goal.start_score}</span><b>→</b>${toeicData.goal.target_scores.join(" / ")}</h1>
    ...
    <p class="toeic-course-note">このコースは英語学習を0から始め、TOEIC 500点または600点を目指す読解練習です。スコア到達を保証するものではありません。公式問題集の演習と組み合わせて使ってください。</p>`;
}
